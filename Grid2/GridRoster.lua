...
--local function IsInGroup() return GetNumPartyMembers() > 0 end
local function IsInRaid() return GetNumRaidMembers() > 0 end
local function GetNumGroupMembers() local rm = GetNumRaidMembers() return (rm > 0 and rm) or GetNumPartyMembers() end
--local function GetNumSubgroupMembers() return GetNumPartyMembers() end
